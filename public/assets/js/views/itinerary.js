...
$('#modal-itinerary-data').on('shown.bs.modal', function (e) {
    ...
    var destination_description = data.config.destination.address;
    if (data.config.itinerary) {
        destination_description = data.config.itinerary.destination.address;
    ...
    $("#itinerary-location-desc").html(destination_description);    
});
