    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 id="config-itinerary-place-title" class="modal-title">Configurar local</h4>
            </div>
            <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <div class="input-group date datetimepicker" id="dtp-local-date">
                                    <input type="text" id="dtp-input" class="form-control" placeholder="Informe data e local"/>
                ...
                <div id="alert-container-place" class="alert alert-danger m-b-5 hide"></div>                    
